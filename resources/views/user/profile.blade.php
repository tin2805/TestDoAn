                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('name') is-invalid @enderror" name="fullname" type="text" id="name" placeholder="{{ __('Enter Your Name') }}" value="{{ $userDetail->fullname }}" required autocomplete="fullname">
                                    @error('name')
